    ...
    public class Execute
    {
        public void runMain()
        {
            try
            {
                ...
                container.Register(
                    Component.For<IStudentData>().ImplementedBy<Database>().Named("StudentData"),
                    Component.For<ISubjectData>().ImplementedBy<Database>().Named("SubjectData"),
                    Component.For<ITranscriptData>().ImplementedBy<Database>().Named("TranscriptData"),
                ...
                List<Student> dssv = studentService.All;

                var subjectService = container.Resolve<ISubjectService>();
                List<Subject> dsmh = subjectService.All;

                var transcriptService = container.Resolve<ITranscriptService>();
                List<Transcript> dsbd = transcriptService.All;
